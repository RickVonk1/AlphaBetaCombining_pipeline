...
#----------------- inputs ------------------#
csv_file_total = '/projects/0/prjs1135/report_Rick/3_Jolada_data/Experiments/Combined_results/3D_plot_info.csv'
csv_file_docking = '/projects/0/prjs1135/report_Rick/3_Jolada_data/Experiments/Combined_results/combined_orientation_file.csv'
...
df1_base = df_maker(csv_file_total, 'norm_haddock_score', 'base_ID')
#df1_avg = df_averaging(df_af_unf,'base_ID','AF3_confidence_score', 'AF3_score')

df2_base = df_maker(csv_file_total,'norm_deltaG','base_ID')
